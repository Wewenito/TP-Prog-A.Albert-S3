...
#    +==========================================================================================+
    ...
    Perso1.initiative = 19
    Perso2 = P.Personnage('Bryan', 18)

    print("P1 :")
    print(f'Pseudo P1 : {Perso1.pseudo}')
    print(f'niveau P1 : {Perso1.niveau}')
    print(f'Pv P1 : {Perso1.PVS}')
    print(f'initiative P1 : {Perso1.initiative}\n')

    print("P2 :")
    print(f'Pseudo P2 : {Perso2.pseudo}')
    print(f'niveau P2 : {Perso2.niveau}')
    print(f'Pv P2 : {Perso2.PVS}')
    print(f'initiative P2 : {Perso2.initiative}\n\n')
    ...
    print(f"{Perso1.pseudo} peut infliger {Perso1.degats()} de degats à {Perso2.pseudo}. \n\n")
...
#    +==========================================================================================+
    ...
    print("P3 (Guerrier) :")
    print(f'Pseudo P3 : {Perso3.pseudo}')
    print(f'niveau P3 : {Perso3.niveau}')
    print(f'Pv P3 : {Perso3.PVS}')
    print(f'init P3 : {Perso3.initiative}\n\n')

    print("P4 (Mage) :")
    print(f'Pseudo P4 : {Perso4.pseudo}')
    print(f'niveau P4 : {Perso4.niveau}')
    print(f'Pv P4 : {Perso4.PVS}')
    print(f'Mana P4 : {Perso4.mana}')
    print(f'init P4 : {Perso4.initiative}\n\n')
